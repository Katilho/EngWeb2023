...
// Como os pedidos de registo de nova tarefa e novo utilizador são feitos na mesma página, esta funcão determina
// que tipo de pedido é que é.
// Se é de um novo utilizador, ou uma nova tarefa.
                    ...
                    getTasks()
                        .then(tasks => {
                            getUsers()
                                .then(users => {
                                    res.writeHead(200, { 'Content-Type': 'text/html;charset=utf-8' })
                                    res.end(templates.genMainPage(users, tasks))
                                })
                        })
                }
